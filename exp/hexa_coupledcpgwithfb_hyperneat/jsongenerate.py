...
expname = 'hexa_coupledcpgwithfb_hyperneat'
bindir = '/home/tarapore/svn_isir/sferes2/trunk/build/default/exp/hexa_coupledcpgwithfb_hyperneat' # where is you executable
resdir = '/home/tarapore/exp/hexa_coupledcpgwithfb_hyperneat/lmBr/exp_' # where are the results to be stored

#################################################
# Arguments for seeded NSGA2
genfile = '/home/tarapore/exp/hexa_coupledcpgwithfb_hyperneat/exp_'  # where are the generation files
generation = 4000                                       # generation to load 
